...
Use `~/repos/opencode-computer-use/scripts/assistant-memory.py`. The owner-only store is
...
```bash
python3 ~/repos/opencode-computer-use/scripts/assistant-memory.py search "audio microphone"
python3 ~/repos/opencode-computer-use/scripts/assistant-memory.py list --category pending
```
...
```bash
python3 ~/repos/opencode-computer-use/scripts/assistant-memory.py remember "Use local speech models" \
...
```bash
python3 ~/repos/opencode-computer-use/scripts/assistant-memory.py forget MEMORY_ID
python3 ~/repos/opencode-computer-use/scripts/assistant-memory.py forget MEMORY_ID --apply
python3 ~/repos/opencode-computer-use/scripts/assistant-memory.py prune
```
...
- Run `python3 ~/repos/opencode-computer-use/scripts/assistant-memory.py validate` after maintenance.
